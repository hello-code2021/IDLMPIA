...
@Desc    :   Generate Guided Grad-CAM heatmap and save it to the "Guided Grad-CAM" folder 
    ...
    Decide generate the heatmap by modifying the variable path="?", eg. path= current_path + '/dataset/test'
'''
...
def modify_backprop(model, name):
    ...
    with g.gradient_override_map({'Relu': name}):
        ...
        if 'inception_resnet_v2' in base_model:
            new_model = load_model('/home/jianghao/Documents/LUNG/ubcnn/new_models/COVID8_basemodel:inception_resnet_v2_inputshape:512.h5')
        if 'inception_v3' in base_model:
            new_model = load_model('/home/jianghao/Documents/LUNG/ubcnn/new_models/COVID8_basemodel:inception_v3_inputshape:512.h5')
        if 'vgg' in base_model :
            new_model = load_model('/home/jianghao/Documents/LUNG/ubcnn/new_models/COVID10_basemodel:vgg_inputshape:512.h5')
        if 'resnet_50' in base_model:
            new_model = load_model('/home/jianghao/Documents/LUNG/ubcnn/new_models/COVID8_basemodel:resnet_50_inputshape:512.h5')
...
#path = current_path + '/dataset/test' # Mutation map folder path eg./dataset/test
path='/home/jianghao/Documents/LUNG/ubcnn/data/G8/test-heatmap/'

if 'inception_resnet_v2' in base_model:
    model = load_model('/home/jianghao/Documents/LUNG/ubcnn/new_models/COVID8_basemodel:inception_resnet_v2_inputshape:512.h5')
    last_conv_layer = 'conv_7b' # the last convolutional layer name 
if 'inception_v3' in base_model:
    model = load_model('/home/jianghao/Documents/LUNG/ubcnn/new_models/COVID8_basemodel:inception_v3_inputshape:512.h5')
    last_conv_layer = 'conv2d_94'
if 'vgg' in base_model :
    model = load_model('/home/jianghao/Documents/LUNG/ubcnn/new_models/COVID10_basemodel:vgg_inputshape:512.h5')
    last_conv_layer = 'block5_conv3'
if 'resnet_50' in base_model:
    model = load_model('/home/jianghao/Documents/LUNG/ubcnn/new_models/COVID8_basemodel:resnet_50_inputshape:512.h5')
