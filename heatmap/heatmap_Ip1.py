...
class GuidedBackpropReLUModel:
    ...
    def __call__(self, input_img, target_category=None):
        ...
        aux1, aux2, output = self.forward(input_img)
...
def get_args():
    ...
    parser.add_argument('--weight-path', type=str, default='./model/InceptionV1_1209/net.pkl',
                        help='pretrained weight path')
    parser.add_argument('--image-path', type=str, default='./data/para_test',
                        help='Input image path')
    parser.add_argument('--output-path', type=str, default='./results/0117test/Ip1',
                        help='Input image path')
