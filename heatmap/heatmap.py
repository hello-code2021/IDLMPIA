...
def get_args():
    ...
    parser.add_argument('--output-path', type=str, default='./results/0117test/Babesia_test_1',
                        help='Input image path')
...
if __name__ == '__main__':
    ...
    for name, module in model._modules.items():
        ...
        name4 = name
    #
    # for name, module in layer4._modules.items():
    #     print(name)
    # input()
    # print(type(name4))
    # print(type(layer4))
    ...
    test_data = torch.utils.data.DataLoader(MyDataSet(os.path.join('data', 'para_test'),
                                            type_data='test'),
    ...
    # print(type(input_img2))
    # print(input_img2.shape)
    # input()

    # outputtest = model(input_img.cuda())
    # x = input_img.cuda()
    # for name, module in model._modules.items():
    #     if module == layer4:
    #         x = x.view(x.size(0), -1)
