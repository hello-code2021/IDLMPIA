...
def get_args():
    ...
    parser.add_argument('--weight-path', type=str, default='./model/resnext50_1209/net.pkl',
                        help='pretrained weight path')
    parser.add_argument('--image-path', type=str, default='./data/para_test',
                        help='Input image path')
    parser.add_argument('--output-path', type=str, default='./results/0117test/resnext',
                        help='Input image path')
