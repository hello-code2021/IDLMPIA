...
class GradCam:
    ...
    def __call__(self, input_img, target_category=None):
        ...
        dicttmp = self.model.layer1.layers._modules
        for name in dicttmp:
            bot = dicttmp[name].dense_layer._modules
            for nm2 in bot:
                try:
                    bot[nm2].weight.grad = None
                except AttributeError as e:
                    pass
        dicttmp = self.model.transition1.transition_layer._modules
        for name in dicttmp:
            try:
                dicttmp[name].weight.grad = None
            except AttributeError as e:
        ...
        dicttmp = self.model.layer2.layers._modules
        for name in dicttmp:
            bot = dicttmp[name].dense_layer._modules
            for nm2 in bot:
                try:
                    ...
                    pass
        dicttmp = self.model.transition2.transition_layer._modules
        for name in dicttmp:
            try:
                dicttmp[name].weight.grad = None
            except AttributeError as e:
        ...
        dicttmp = self.model.layer3.layers._modules
        for name in dicttmp:
            bot = dicttmp[name].dense_layer._modules
            for nm2 in bot:
                try:
                    ...
                    pass
        dicttmp = self.model.transition3.transition_layer._modules
        for name in dicttmp:
            try:
                dicttmp[name].weight.grad = None
            except AttributeError as e:
        ...
        dicttmp = self.model.layer4.layers._modules
        for name in dicttmp:
            bot = dicttmp[name].dense_layer._modules
            for nm2 in bot:
                try:
...
def get_args():
    ...
    parser.add_argument('--weight-path', type=str, default='./model/DenseNet_1209/net.pkl',
                        help='pretrained weight path')
    parser.add_argument('--image-path', type=str, default='./data/para_test',
                        help='Input image path')
    parser.add_argument('--output-path', type=str, default='./results/0117test/densenet',
                        help='Input image path')
